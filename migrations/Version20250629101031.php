 ...
 */
final class Version20250629101031 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE withdrawals (id INT AUTO_INCREMENT NOT NULL, made_by_id INT NOT NULL, cash_register_session_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', amount NUMERIC(10, 2) NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_1DD5572F90B9D269 (made_by_id), INDEX IDX_1DD5572F6C172579 (cash_register_session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE withdrawal (id INT AUTO_INCREMENT NOT NULL, made_by_id INT NOT NULL, cash_register_session_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', amount NUMERIC(10, 2) NOT NULL, comment LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_6D2D3B456C172579 (cash_register_session_id), INDEX IDX_6D2D3B4590B9D269 (made_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
